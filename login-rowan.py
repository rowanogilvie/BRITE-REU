...
if cookie != None:
    ...
    if uname == None or pword == None:
        ...
        <head>
        	<title>DASR</title>
        	<meta charset="utf-8"/>
        	<link rel="stylesheet" href="../dapr_test/css/bootstrap.min.css" type="text/css" />
        ...
        if validuser == None:
            ...
            print("""
                ...
                <head>
                	<title>DASR</title>
                	<meta charset="utf-8"/>
                	<link rel="stylesheet" href="/students_17/Group9/css/login.css" type="text/css" />
                	<meta name="viewport" content="width=device-width, initial-scale=1.0"/>
                </head>
                ...
                <div class="login-page">
                    ...
                    <form class="login-form" action='http://128.197.87.29/cgi-bin/dapr_test/login.py' method ='post'>
                      ...
                      <p class="message" style="color:red ! important;"><b>Invalid username or password!</b></p>
                	    <p class="message"><a href="http://128.197.87.29/cgi-bin/dapr_test/error.py">Reset password</a></p>
